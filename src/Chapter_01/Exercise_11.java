...
public class Exercise_11 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Year 1 population projection : " + population);

        population += birth - death + immigrant;
        System.out.println("Year 2 population projection : " + population);

        population += birth - death + immigrant;
        System.out.println("Year 3 population projection : " + population);

        population += birth - death + immigrant;
        System.out.println("Year 4 population projection : " + population);

        population += birth - death + immigrant;
        System.out.println("Year 5 population projection : " + population);
    }
}